...
namespace BikeStore.Data.Migrations
{
    ...
    [Migration("20180924022126_BikeTableDrivetrainUpdate")]
    partial class BikeTableDrivetrainUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BikeStore.Data.Models.Bike.Bike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("ElectricMotor")
                        .HasMaxLength(150);
            ...
            modelBuilder.Entity("BikeStore.Data.Models.User.User", b =>
                {
            ...
            modelBuilder.Entity("BikeStore.Data.Models.Bike.Bike", b =>
                {
                    b.HasOne("BikeStore.Data.Models.User.User", "User")
                        .WithMany("Bikes")
